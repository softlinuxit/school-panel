...
const imageBaseUrl = `http://localhost:8080/api/download?link=`;
...
const accessCheck = [
  ...
  {
    value: ["/misadmissiondashboard", "/misfeedashboard", "/misadmissionreport", "/misadmissionstatusreport", "/misadmissionanalysis", "/misfeecollectionreport",
      "/misstaffanalysis"],
    label: "MIS Reports",
  },
];
...
const rollNoSequenceData = [
  ...
  { value: "Boys First", label: "Boys First" },
